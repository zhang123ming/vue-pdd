    ...
    <div class="girlgoods">
      <ul>
        <li class="girlBox" v-for="item in girlGoodsInfo" :key="item.id">
          <img class="girBoxImg" v-lazy="item.girl_goods_img" alt />
          ...
          <div class="girl_content">
            ...
            <div class="img">
              <img :src="item.girl_goods_tou1" alt />
              <img :src="item.girl_goods_tou2" alt />
            </div>
          </div>
        </li>
      </ul>
...
export default {
  ...
  methods: {
    ...
    _initBScroll() {
      this.LeftScroll = new BScroll(this.$refs.bscroll, {
        // scrollX: true,
        // click: true,
        pullUpLoad: true
        // probeType: 3
